...
contract MockERC20 is Context, ERC20, ERC20Detailed {
    mapping(address => bool) public minters;
    address public owner;

    modifier onlyMinter() {
        require(minters[msg.sender], "Only Minter can mint and burn");
        _;
    }
    ...
    function burn(address _from, uint256 _amount) public virtual onlyMinter {
        _burn(_from, _amount);
    }
