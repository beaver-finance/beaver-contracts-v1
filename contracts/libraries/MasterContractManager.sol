...
contract MasterContractManager is Ownable, BoringFactory {
    ...
    function _calculateDomainSeparator(uint256 chainId) private view returns (bytes32) {
        return keccak256(abi.encode(DOMAIN_SEPARATOR_SIGNATURE_HASH, keccak256("Beaver V1"), chainId, address(this)));
    }
